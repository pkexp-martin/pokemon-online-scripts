...
export class UserInfo implements IPlugin {

    public sourcePath: string;

    public handleCommandSeen(channel, src, commandData, tar): string {
    ...
    handleCommandAliases(channel, src, commandData, tar): string {
    ...
    handleCommandTier(channel, src, commandData, tar): string {
        if (tar === undefined) {
    ...
    handleCommandTopChannels(channel, src, commandData, tar) {
    ...
    handleCommandChannelUsers(channel, src, commandData, tar) {
        if (commandData === undefined) {
...
export var instance: IPlugin = new UserInfo();